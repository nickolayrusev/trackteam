 ...
 */
@Entity
@Table(name = "alltime_standing_entries")
public class AlltimeStandingEntry {
    private Long id;
    private Long alltimeStandingId;
    private Long teamId;
    private Long pos;
    private Long played;
    private Long won;
    ...
    @Basic
    @Column(name = "alltime_standing_id", nullable = false)
    public Long getAlltimeStandingId() {
        return alltimeStandingId;
    }

    public void setAlltimeStandingId(Long alltimeStandingId) {
        this.alltimeStandingId = alltimeStandingId;
    }
    ...
    @Basic
    @Column(name = "recs", nullable = true)
    public Long getRecs() {
        return recs;
    }
    ...
    public boolean equals(Object o) {
        ...
        AlltimeStandingEntry that = (AlltimeStandingEntry) o;

        if (id != null ? !id.equals(that.id) : that.id != null) return false;
        if (alltimeStandingId != null ? !alltimeStandingId.equals(that.alltimeStandingId) : that.alltimeStandingId != null)
            return false;
        ...
        if (recs != null ? !recs.equals(that.recs) : that.recs != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (alltimeStandingId != null ? alltimeStandingId.hashCode() : 0);
        ...
        result = 31 * result + (recs != null ? recs.hashCode() : 0);
