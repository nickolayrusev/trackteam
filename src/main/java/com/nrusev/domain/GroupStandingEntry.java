 ...
 */
@Entity
@Table(name = "group_standing_entries")
public class GroupStandingEntry {
    private Long id;
    private Long groupStandingId;
    private Long teamId;
    private Long pos;
    private Long played;
    private Long won;
    ...
    @Basic
    @Column(name = "group_standing_id", nullable = false)
    public Long getGroupStandingId() {
        return groupStandingId;
    }

    public void setGroupStandingId(Long groupStandingId) {
        this.groupStandingId = groupStandingId;
    }
    ...
    public boolean equals(Object o) {
        ...
        GroupStandingEntry that = (GroupStandingEntry) o;

        if (id != null ? !id.equals(that.id) : that.id != null) return false;
        if (groupStandingId != null ? !groupStandingId.equals(that.groupStandingId) : that.groupStandingId != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (groupStandingId != null ? groupStandingId.hashCode() : 0);
