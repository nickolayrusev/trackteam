...
public class County {
    ...
    public boolean equals(Object o) {
        ...
        County counties = (County) o;

        if (id != null ? !id.equals(counties.id) : counties.id != null) return false;
        ...
        if (placeId != null ? !placeId.equals(counties.placeId) : counties.placeId != null) return false;
        ...
        if (stateId != null ? !stateId.equals(counties.stateId) : counties.stateId != null) return false;
        if (partId != null ? !partId.equals(counties.partId) : counties.partId != null) return false;
        if (level != null ? !level.equals(counties.level) : counties.level != null) return false;
